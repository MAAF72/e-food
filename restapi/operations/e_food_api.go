...
func NewEFoodAPI(spec *loads.Document) *EFoodAPI {
	return &EFoodAPI{
		...
		MenuCategoryListHandler: menu.CategoryListHandlerFunc(func(params menu.CategoryListParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation menu.CategoryList has not yet been implemented")
		}),
		UserLoginHandler: user.LoginHandlerFunc(func(params user.LoginParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation user.Login has not yet been implemented")
		}),
		UserRegisterHandler: user.RegisterHandlerFunc(func(params user.RegisterParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation user.Register has not yet been implemented")
		}),

		// Applies when the "X-App-ID" header is set
		AppIDAuth: func(token string) (interface{}, error) {
			return nil, errors.NotImplemented("api key auth (AppID) X-App-ID from header param [X-App-ID] has not yet been implemented")
		},
...
type EFoodAPI struct {
	...
	// AppIDAuth registers a function that takes a token and returns a principal
	// it performs authentication based on an api key X-App-ID provided in the header
	AppIDAuth func(string) (interface{}, error)
...
func (o *EFoodAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *EFoodAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}
...
func (o *EFoodAPI) Validate() error {
	...
	if o.AppIDAuth == nil {
		unregistered = append(unregistered, "XAppIDAuth")
	}
	if o.BearerAuth == nil {
...
func (o *EFoodAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	...
	for name := range schemes {
		...
		case "AppID":
			scheme := schemes[name]
			result[name] = o.APIKeyAuthenticator(scheme.Name, scheme.In, o.AppIDAuth)
