...
type CategoryListHandlerFunc func(CategoryListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CategoryListHandlerFunc) Handle(params CategoryListParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// CategoryListHandler interface for that can handle valid category list params
type CategoryListHandler interface {
	Handle(CategoryListParams, interface{}) middleware.Responder
}
