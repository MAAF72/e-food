...
/*RegisterOK Successful register
...
type RegisterOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.RegisterSuccess `json:"body,omitempty"`
}
...
func (o *RegisterOK) WithPayload(payload *models.RegisterSuccess) *RegisterOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the register o k response
func (o *RegisterOK) SetPayload(payload *models.RegisterSuccess) {
	o.Payload = payload
}
